		...
		new WebpackDeployer({
		  environments: {
		    staging: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/staging/news/projects/all/202003-cancellations/build',
		    ...
		    production: {
		      region: 'us-west-1',
		      params: {
		        Bucket: 'static.startribune.com/news/projects/all/202003-cancellations/build',
		        DistributionId: 'BUCKETIDHERE'
		      }
		    }
		  },
